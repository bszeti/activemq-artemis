export "MAVEN_OPTS=-Dorg.slf4j.simpleLogger.log.org.apache.activemq.artemis.jms.example=debug -Dorg.slf4j.simpleLogger.log.org.apache.qpid.jms=info -Dorg.slf4j.simpleLogger.log.org.springframework.jms.connection.JmsTransactionManager=debug"
