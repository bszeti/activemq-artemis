 ...
 */
public class TransactionFailoverAmqpExample {
   ...
   public static void main(final String[] args) throws Exception {
      ...
      try {
         server0 = ServerUtil.startServer(args[0], TransactionFailoverAmqpExample.class.getSimpleName() + "0", 0, 5000);
         server1 = ServerUtil.startServer(args[1], TransactionFailoverAmqpExample.class.getSimpleName() + "1", 1, 5000);
...
//         Queue queue = (Queue) initialContext.lookup("queue/exampleQueue");
         ...
         String url = "failover:(amqp://localhost:61616,amqp://localhost:61617)??failover.maxReconnectAttempts=-1&failover.amqpOpenServerListAction=IGNORE&jms.prefetchPolicy.all=5&jms.forceSyncSend=true";
